...
/* Hover tooltip carrying the review excerpt. Pure CSS via a data attribute —
   no JS, and it costs nothing until the pointer is actually over the card. */
.ach-card[data-review]:hover::after {{
...
.ach-card[data-review]::before {{
    content: "hover to read";
    position: absolute;
    top: 14px;
    right: 16px;
    font-family: 'JetBrains Mono', monospace;
