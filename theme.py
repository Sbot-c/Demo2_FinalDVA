...
def _background_css():
    far = _starfield_layer(110, seed=11, max_radius=1.1, max_alpha=0.55)
    mid = _starfield_layer(55, seed=22, max_radius=1.5, max_alpha=0.75)
    near = _starfield_layer(22, seed=33, max_radius=2.1, max_alpha=0.95)
...
@keyframes drift {{
    ...
    to   {{ background-position: -1400px 700px, -900px 450px, -600px 300px, 0 0, 0 0, 0 0; }}
}}
"""
...
@media (prefers-reduced-motion: reduce) {{
    .stApp, .halo, .halo-soft {{ animation: none !important; }}
